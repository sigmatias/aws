"""Captura pantalla completa del monitor secundario para evidencias EP3.

Uso:
    python tools/snap_ep3_secondary.py 1
    python tools/snap_ep3_secondary.py 2 --delay 3
    python tools/snap_ep3_secondary.py --list

Guarda en:
    informe/capturas_ep3/captura_XX.png
"""
import argparse
import ctypes
import sys
...
DEST = Path(__file__).resolve().parent.parent / "informe" / "capturas_ep3"
...
def main():
    parser = argparse.ArgumentParser(
        description="Captura el monitor secundario completo para EP3."
    )
    ...
    parser.add_argument(
        ...
        type=Path,
        default=DEST,
        help="carpeta destino; default informe/capturas_ep3",
    )
